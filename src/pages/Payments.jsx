...
export default function Payments() {
  ...
  const handleDelete = async () => {
    setDeleting(true);
    // Payments: hard delete (low-risk for config payments; real ones should be refunded)
    await PaymentAPI.update(confirmDelete.id, { status: "waived", notes: (confirmDelete.notes || "") + " [deleted]" });
  ...
  return (
    <div className="p-4 lg:p-8 space-y-6 max-w-6xl mx-auto">
      ...
      <ConfirmDialog
        ...
        description="This payment will be marked as waived and removed from the view."
        confirmLabel="Remove"
      />
    </div>
  );
